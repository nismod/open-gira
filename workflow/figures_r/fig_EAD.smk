...
### outputs ###
out_diff_EAD_agg = os.path.join(config['output_dir'], 'figures', 'intermediate_files', f'difference_{merge_key_EAD_agg}_{metric_EAD_agg}.gpkg')
out_diff_EAD_agg_norm = os.path.join(config['output_dir'], 'figures', 'intermediate_files', f'difference_{merge_key_EAD_agg_norm}_{metric_EAD_agg_norm}.gpkg')
out_diff_EAD_indiv = os.path.join(config['output_dir'], 'figures', 'intermediate_files', f'difference_{merge_key_EAD_indiv}_{metric_EAD_indiv}.gpkg')
