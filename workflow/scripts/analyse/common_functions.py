...
def find_storm_files(file_type, results_folder, region_eval, sample_eval, nh_eval, thrval):
    ...
    indiv_storm_path = os.path.join(results_folder, "power_intersection", "storm_data", "individual_storms")
