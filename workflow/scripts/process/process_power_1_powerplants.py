...
if __name__ == "__main__":
    ...
    powerplants["box_id"] = idxbox(
        powerplants["latitude"], powerplants["longitude"], boxlen, lat_max, num_cols, lon_min, tot_boxes
    )  # sort for box
    ...
    for id in tqdm(
        ...
        all_boxes_pp_file = os.path.join(
            output_dir, "power_processed", "all_boxes", f"box_{id}", f"powerplants_box_{id}.csv"
        )
