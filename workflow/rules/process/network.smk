...
out_network = (
    expand(
        [
            os.path.join(
                config['output_dir'], "power_processed", "all_boxes", "{box_id}", "plants_{box_id}.gpkg"
            ),
            os.path.join(
                config['output_dir'], "power_processed", "all_boxes", "{box_id}", "network_{box_id}.gpkg"
            ),
            os.path.join(
                config['output_dir'], "power_processed", "all_boxes", "{box_id}", "targets_{box_id}.gpkg"
            ),
        ],
        box_id=all_boxes,
    ),
