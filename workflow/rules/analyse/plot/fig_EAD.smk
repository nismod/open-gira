...
### outputs ###
out_diff_EAD_agg = os.path.join(
    config["output_dir"],
    "power_figures",
    "intermediate_files",
    f"difference_{merge_key_EAD_agg}_{metric_EAD_agg}.gpkg",
)
out_diff_EAD_agg_norm = os.path.join(
    config["output_dir"],
    "power_figures",
    "intermediate_files",
    f"difference_{merge_key_EAD_agg_norm}_{metric_EAD_agg_norm}.gpkg",
)
out_diff_EAD_indiv = os.path.join(
    config["output_dir"],
    "power_figures",
    "intermediate_files",
    f"difference_{merge_key_EAD_indiv}_{metric_EAD_indiv}.gpkg",
)

out_diff_EAD_indiv_plot = os.path.join(
    config["output_dir"], "power_figures", "EAD_difference_perc_recon.png"
)
out_current_EAD_indiv_plot = os.path.join(
    config["output_dir"], "power_figures", "EAD_current_recon_per_km.png"
)
out_diff_EAD_plot = os.path.join(
    config["output_dir"], "power_figures", "EAD_difference_recon.png"
)
out_diff_EAD_plot_norm = os.path.join(
    config["output_dir"], "power_figures", "EAD_difference_recon_norm.png"
)
...
rule fig_aggregate_EAD_agg:
    ...
    output:
        out_agg_EAD_agg=os.path.join(
            config["output_dir"],
            "power_figures",
            "intermediate_files",
            f"mean_{merge_key_EAD_agg}_{metric_EAD_agg}.gpkg",
        ),
    script:
...
rule fig_aggregate_EAD_agg_norm:
    ...
    output:
        out_agg_EAD_agg_norm=os.path.join(
            config["output_dir"],
            "power_figures",
            "intermediate_files",
            f"mean_{merge_key_EAD_agg_norm}_{metric_EAD_agg_norm}.gpkg",
        ),
    script:
        os.path.join("..", "..", "..", "scripts", "analyse", "figures", "mean_agg.py")
...
rule fig_aggregate_EAD_indiv:
    ...
    output:
        out_agg_EAD_indiv=os.path.join(
            config["output_dir"],
            "power_figures",
            "intermediate_files",
            f"mean_{merge_key_EAD_indiv}_{metric_EAD_indiv}.gpkg",
        ),
    script:
        os.path.join("..", "..", "..", "scripts", "analyse", "figures", "mean_agg.py")
