...
out_agg_EACA_file = os.path.join(config['output_dir'], 'power_figures', 'intermediate_files', f'mean_{merge_key_EACA}_{metric_EACA}.gpkg')
out_agg_EACA_plot_perc = os.path.join(config['output_dir'], 'power_figures', 'EACA_perc_diff_aggregate.png')
