...
def test_network_hazard_intersection():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        sp.check_output([
            ...
            "-m",
            "snakemake", 
            "outputs/northeast-oxford-slice3.highway-core_aqueduct_river_splits.geoparquet",
            "outputs/northeast-oxford-slice3.highway-core_aqueduct_river_splits.parquet",
            "-F", 
            "-j1",
            "--keep-target-files",
